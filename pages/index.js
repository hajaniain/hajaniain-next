...
export default function Home() {
  ...
  return (
    <div>
      ...
      <div className="flex flex-col justify-between h-screen bg-gray-200 dark:bg-gray-800">
        <div></div>
        <div className="flex flex-col justify-center"x>
          ...
          <div className="flex flex-row mx-auto mt-6 mb-16">
            ...
            />
            <SocialLink
              href="https://www.linkedin.com/in/hajaniaina-rafaliarintsoa-a5b202b9/"
        ...
        <div className="flex justify-center">
          <div className="opacity-70 bottom-0 lg:w-1/2 md:w-3/4 sm:w-full ml-auto mr-auto">
            {darkMode ? (
